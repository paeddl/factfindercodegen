...
class ClusterApi
{
     ...
     * @return void
     */
    public function fullSyncUsingPOST()
    {
    ...
    protected function fullSyncUsingPOSTRequest()
    {
        ...
        $resourcePath = '/rest/v5/cluster/database/sync/full';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DatabaseState
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DatabaseState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDatabaseStateUsingGETWithHttpInfo($channel)
    {
        $returnType = '\Swagger\Client\Model\DatabaseState';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DatabaseState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function getDatabaseStateUsingGETRequest($channel)
    {
        ...
        $resourcePath = '/rest/v5/cluster/{channel}/database/state';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getImportStateUsingGET
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ImportState
     */
    public function getImportStateUsingGET($channel)
    {
        list($response) = $this->getImportStateUsingGETWithHttpInfo($channel);
        return $response;
    }

    /**
     * Operation getImportStateUsingGETWithHttpInfo
     *
     * Show the import state of this node.
     *
     * @param  string $channel channel (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImportState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getImportStateUsingGETWithHttpInfo($channel)
    {
        $returnType = '\Swagger\Client\Model\ImportState';
        $request = $this->getImportStateUsingGETRequest($channel);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ImportState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getImportStateUsingGETAsync
     *
     * Show the import state of this node.
     *
     * @param  string $channel channel (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImportStateUsingGETAsync($channel)
    {
        return $this->getImportStateUsingGETAsyncWithHttpInfo($channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getImportStateUsingGETAsyncWithHttpInfo
     *
     * Show the import state of this node.
     *
     * @param  string $channel channel (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImportStateUsingGETAsyncWithHttpInfo($channel)
    {
        $returnType = '\Swagger\Client\Model\ImportState';
        $request = $this->getImportStateUsingGETRequest($channel);
    ...
    /**
     * Create request for operation 'getImportStateUsingGET'
     *
     * @param  string $channel channel (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getImportStateUsingGETRequest($channel)
    {
        // verify the required parameter 'channel' is set
        if ($channel === null || (is_array($channel) && count($channel) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel when calling getImportStateUsingGET'
            );
        }

        $resourcePath = '/rest/v5/cluster/{channel}/import/state';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ClusterState
     */
    public function getStateUsingGET($channel)
    {
        list($response) = $this->getStateUsingGETWithHttpInfo($channel);
        return $response;
    }

    /**
     * Operation getStateUsingGETWithHttpInfo
     *
     * Get the cluster state. Includes database & import & cache state.
     *
     * @param  string $channel channel (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ClusterState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStateUsingGETWithHttpInfo($channel)
    {
        $returnType = '\Swagger\Client\Model\ClusterState';
        $request = $this->getStateUsingGETRequest($channel);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ClusterState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getStateUsingGETAsync
     *
     * Get the cluster state. Includes database & import & cache state.
     *
     * @param  string $channel channel (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStateUsingGETAsync($channel)
    {
        return $this->getStateUsingGETAsyncWithHttpInfo($channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStateUsingGETAsyncWithHttpInfo
     *
     * Get the cluster state. Includes database & import & cache state.
     *
     * @param  string $channel channel (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStateUsingGETAsyncWithHttpInfo($channel)
    {
        $returnType = '\Swagger\Client\Model\ClusterState';
        $request = $this->getStateUsingGETRequest($channel);
    ...
    /**
     * Create request for operation 'getStateUsingGET'
     *
     * @param  string $channel channel (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStateUsingGETRequest($channel)
    {
        // verify the required parameter 'channel' is set
        if ($channel === null || (is_array($channel) && count($channel) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel when calling getStateUsingGET'
            );
        }

        $resourcePath = '/rest/v5/cluster/{channel}/state';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function pruneUsingPOSTRequest($channel)
    {
        ...
        $resourcePath = '/rest/v5/cluster/{channel}/database/prune';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function syncDatabaseUsingPOSTRequest($channel, $verbose = 'false')
    {
        ...
        $resourcePath = '/rest/v5/cluster/{channel}/database/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
