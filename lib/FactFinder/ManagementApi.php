...
class ManagementApi
{
    ...
    protected function changeLogLevelUsingPOSTRequest($log_level)
    {
        ...
        $resourcePath = '/rest/v5/management/changeLogLevel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($log_level !== null) {
            $queryParams['logLevel'] = ObjectSerializer::toQueryValue($log_level, null);
        }
    ...
    protected function flushCacheUsingPOSTRequest($channel = null)
    {
        ...
        $resourcePath = '/rest/v5/management/flushCache';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function flushLogsUsingPOSTRequest()
    {
        ...
        $resourcePath = '/rest/v5/management/flushLogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getExpirationMessagesUsingGETRequest($channel = null)
    {
        ...
        $resourcePath = '/rest/v5/management/expiration';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function reloadConfigurationUsingPOSTRequest($channel = null)
    {
        ...
        $resourcePath = '/rest/v5/management/reloadConfiguration';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function resetLogLevelUsingPOSTRequest()
    {
        ...
        $resourcePath = '/rest/v5/management/resetLogLevel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
