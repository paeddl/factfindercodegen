...
/**
 * PredBasketClickEvent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PredBasketClickEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PredBasketClickEvent';
     ...
     * Sets user_id
     *
     * @param string $user_id The user ID of the user clicking the suggested product.
     *
     * @return $this
     */
