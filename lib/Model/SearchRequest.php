...
class SearchRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'params' => '\Swagger\Client\Model\SearchParams',
     ...
     * Sets params
     *
     * @param \Swagger\Client\Model\SearchParams $params params
     *
     * @return $this
     */
     ...
     * Sets user_id
     *
     * @param string $user_id The user ID of the user sending this search request.
     *
     * @return $this
     */
