...
/**
 * DeleteMarketRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteMarketRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteMarketRequest';
     ...
     * Sets market_ids
     *
     * @param string[] $market_ids The ids of the markets which should be deleted.
     *
     * @return $this
     */
